...
final class MailService
{
    ...
    private function layout(string $body): string{$name=htmlspecialchars((string)Setting::get('agency_name','Veelox Digital'));$address=htmlspecialchars((string)Setting::get('agency_address','Eastbourne, East Sussex'));return '<!doctype html><html><body style="margin:0;background:#f4f5f8;font-family:Arial,sans-serif;color:#18202b"><table width="100%" cellpadding="0" cellspacing="0"><tr><td style="padding:35px 15px"><table width="600" align="center" cellpadding="0" cellspacing="0" style="max-width:600px;background:#fff;border-radius:18px"><tr><td style="padding:28px 35px;background:#171a24;color:#fff;border-radius:18px 18px 0 0"><strong style="font-size:20px">'.$name.'</strong></td></tr><tr><td style="padding:35px;line-height:1.7">'.$body.'</td></tr><tr><td style="padding:20px 35px;border-top:1px solid #eee;color:#777;font-size:12px">'.$name.' · '.$address.'</td></tr></table></td></tr></table></body></html>';}
}
